...
devices_df = pd.DataFrame(nd.download(device_db_id, api_key=notion_token, resolve_relation_values=True))
...
tickets = pd.DataFrame(nd.download(tickets_db_id, api_key=notion_token, resolve_relation_values=True))
